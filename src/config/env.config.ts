 ...
 * @type {CookieOptions}
 */
export const COOKIE_OPTIONS: CookieOptions = { httpOnly: true, secure: HTTPS, signed: true, sameSite: HTTPS ? 'none' : 'lax', domain: AUTH_COOKIE_DOMAIN }
 ...
 * @type {string}
 */
export const CDN_USERS = __env__('BC_CDN_USERS', false)
 ...
 * @type {string}
 */
export const CDN_TEMP_USERS = __env__('BC_CDN_TEMP_USERS', false)
 ...
 * @type {string}
 */
export const CDN_CARS = __env__('BC_CDN_CARS', false)
 ...
 * @type {string}
 */
export const CDN_TEMP_CARS = __env__('BC_CDN_TEMP_CARS', false)
 ...
 * @type {string}
 */
export const CDN_LOCATIONS = __env__('BC_CDN_LOCATIONS', false)
 ...
 * @type {string}
 */
export const CDN_TEMP_LOCATIONS = __env__('BC_CDN_TEMP_LOCATIONS', false)
 ...
 * @type {string}
 */
export const CDN_CONTRACTS = __env__('BC_CDN_CONTRACTS', false)
 ...
 * @type {string}
 */
export const CDN_TEMP_CONTRACTS = __env__('BC_CDN_TEMP_CONTRACTS', false)
 ...
 * @type {string}
 */
export const CDN_LICENSES = __env__('BC_CDN_LICENSES', false)
